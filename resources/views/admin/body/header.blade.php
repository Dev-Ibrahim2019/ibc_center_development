        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="index.html" class="header-logo">
                    <img src="{{ asset('cms/assets/img/brand/logo.png') }}" class="logo-1" alt="logo">
                    <img src="{{ asset('cms/assets/img/brand/logo-white.png') }}" class="dark-logo-1" alt="logo">
                </a>
            </div>
                                ...
                                <div class="main-header-profile bg-primary p-3">
                                    <div class="d-flex wd-100p">
                                        <div class="main-img-user"><img alt=""
                                                src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}" class=""></div>
