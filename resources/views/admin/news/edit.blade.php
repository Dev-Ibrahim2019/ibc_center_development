        ...
        <form action="{{route('admin.news.update', $news->id)}}" method="POSt" enctype="multipart/form-data">
            ...
            <div class="row row-sm">
                <div class="col-lg-10 m-5">
                    <div class="card">
                        <div class="card-body">
                            <div class="mb-4 main-content-label">Update News</div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="auther" id="auther"
                                            placeholder="Auther" value="{{ $news->auther }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="title_ar" id="title_ar"
                                            placeholder="Title Arabic" value="{{ $news->title_ar }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="title_en" id="title_en"
                                            placeholder="Title English" value="{{ $news->title_en }}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="content_ar">{{ $news->content_ar }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea name="content_en">{{ $news->content_en }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary waves-effect waves-light text-light">Update</button>
