                            ...
                            <div id="wizard1">
                                ...
                                <section>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <input type="text" class="form-control required" name="course_ar" id="course_ar"
                                            placeholder="Course Name in Arabic" value="{{ $course->course_ar }}">
                                    </div>
                                    <div class="control-group form-group">
                                        <label class="form-label">Course En.</label>
                                        <input type="text" class="form-control required" name="course_en" id="course_en"
                                            placeholder="Course Name in English" value="{{ $course->course_en }}">
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 control-group form-group">
                                            ...
                                            <input type="date" class="form-control required" name="start_at"
                                                id="start_at" value="{{ $course->start_at }}">
                                        </div>
                                        <div class="col-sm-4 control-group form-group">
                                            <label class="form-label">Status</label>
                                            <select class="form-control" name="status" id="status">
                                                <option {{$course->status == 'Active' ? 'selected': ''}} value="Active">Active</option>
                                                <option {{$course->status == 'Full' ? 'selected': ''}} value="Full">Full up</option>
                                                <option {{$course->status == 'Expired' ? 'selected': ''}} value="Expired">Expired</option>
                                            </select>
                                        </div>
                                        <div class="col-sm-4 control-group form-group mb-0">
                                            <label class="form-label">Price</label>
                                            <input type="number" class="form-control required" name="price"
                                                id="price" placeholder="Price" value="{{ $course->price }}">
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    <div class="control-group form-group">
                                        ...
                                        <textarea id="topics_ar" name="topics_ar" class="form-control" placeholder="Topics In Arabic" required=""
                                            rows="3">{{ $course->topics_ar }}</textarea>
                                    </div>
                                    <div class="control-group form-group">
                                        <label class="form-label">Topics En</label>
                                        <textarea id="topics_en" name="topics_en" class="form-control" placeholder="Topics In English" required=""
                                            rows="3">{{ $course->topics_en }}</textarea>
                                    </div>
                                    <div class="control-group form-group">
                                        <label class="form-label">Objectives Ar</label>
                                        <textarea id="objectives_ar" name="objectives_ar" class="form-control" placeholder="Objectives In Arabic" required=""
                                            rows="3">{{ $course->objectives_ar }}</textarea>
                                    </div>
                                    <div class="control-group form-group">
                                        <label class="form-label">Objectives En</label>
                                        <textarea id="objectives_en" name="objectives_en" class="form-control" placeholder="Objectives In English"
                                            required="" rows="3">value="{{ $course->objectives_en }}"</textarea>
                                    </div>
                                </section>
                                <h3>Instructor</h3>
                                <section>
                                    ...
                                    <div class="control-group form-group">
                                        ...
                                        <input type="text" class="form-control required" id="instructor_en"
                                            ...
                                            value="{{ $course->instructor_en }}">
                                    </div>
                                </section>
                            </div>
                            <button type="submit" class="btn btn-primary text-light mt-3 px-5">Update</button>
